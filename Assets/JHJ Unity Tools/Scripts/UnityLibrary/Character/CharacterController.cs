...
namespace Character
{
    ...
    public class CharacterController : MonoBehaviour
    {
        ...
        /// 캐릭터의 전방 벡터
        /// </summary>
        public Vector3 Forward => center.forward;

        /// <summary>
        /// Right 프로퍼티 <br/>
        /// 캐릭터의 우측 벡터
        /// </summary>
        public Vector3 Right => center.right;

        /// <summary>
        /// Up 프로퍼티 <br/>
        /// 캐릭터의 상단 벡터
        /// </summary>
        public Vector3 Up => center.up;
        ...
        public void SetMovement(Vector3 movement, Space space = Space.World)
        {
            ...
            mMovement = center.forward * movement.z + center.right * movement.x + center.up * movement.y;
        }
